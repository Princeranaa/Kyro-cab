...
function RidePopup({ setRidePopupPanle, setConfirmRidePopupPanle }) {
    return (
        <div>
            ...
            <div className="flex flex-col gap-2 items-center justify-between ">
                ...
                <div className="w-full mt-5 flex  items-center justify-between">
                    ...
                    <button onClick={() => { setConfirmRidePopupPanle(true) }} className=" bg-green-600  p-3 px-8 text-center text-white font-semibold rounded-lg">Accept Ride</button>
                </div>
            </div>
