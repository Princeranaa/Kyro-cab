function VehicalePanel({ setVehiclePanleOpen, setConfirmRideVehicle }) {
    return (
        <div>
            < h5 onClick={() => { setVehiclePanleOpen(false) }} className='p-3 text-center w-[93%] absolute top-0' > <i className="text-3xl text-gray-600 ri-arrow-down-wide-line"></i></h5 >
            <h3 className='text-2xl font-semibold mb-5'>Choose a Vehicle</h3>

            <div onClick={(() => { setConfirmRideVehicle(true) })} className='w-full p-3 mb-2 border-2 border-black rounded-xl flex items-center justify-between'>
