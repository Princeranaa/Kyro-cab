        ...
        <div className='p-8 h-screen flex flex-col justify-between'>
            <div>
                ...
                <div className='flex gap-2 items-center justify-center'>
                    <p className='text-center'>Join a fleet?</p> <Link to={"/captain-signup"} className='text-blue-600'>Register as Captain</Link>
                </div>
            </div>

            <div>
                <Link to={"/login"} className='bg-[#10b461] flex items-center justify-center text-white mb-8 font-semibold rounded px-4 py-2 w-full text-lg placeholder:text-base'>Sign in as User</Link>
            </div>
        </div>
    )
}
